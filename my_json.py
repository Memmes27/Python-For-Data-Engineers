...
transactions_list_of_dict = json.loads(json_formatted_string)
pprint(transactions_list_of_dict)
# > [{'Country': 'France',
# >   'CustomerID': 12583,
# >   'Description': 'MINI PAINT SET VINTAGE',
# >   'InvoiceDate': '12/1/2010 8:45',
...
pprint(transactions_list_of_dict[0].keys())
...
for transaction in transactions_list_of_dict:
...
pprint(json.dumps(transactions_list_of_dict))
...
with open("./data/dumped_json.json", 'w') as json_file:
    json.dump(transactions_list_of_dict, json_file)